...
;(function ( $, window, document, undefined ) {
	var pluginName = "waterripple",
        defaults = {
            delay		: 100,		//delay before re-drawing the next frame
			riprad		: 7,		//single ripple radius
			line_width	: 20,
			arbitrary	: 500,		//generate a new random ripple every n-mseconds, false - turns off random ripples
